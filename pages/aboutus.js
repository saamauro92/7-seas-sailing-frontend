  ...
  return (
    <>
      {homepage && homepage.attributes && (
        <SEO data={homepage.attributes.seo} metaTitle="About us - " />
      )}
      {imgBanner && (
        <div
      ...
      <div className="uk-container uk-container-medium uk-padding@m   uk-animation-slide-bottom  uk-background-muted ">
        ...
        about.attributes.banner_two.data.attributes.url ? (
          <div
            className=" uk-background-cover uk-height-large uk-width-1-1@m about-banner-two  "
          ...
          <div
            className=" uk-background-cover uk-height-large uk-width-1-1@m about-banner-two  "
            data-src={
              about.attributes.banner_two.data.attributes.formats.medium.url
            }
            data-srcset={
              about.attributes.banner_two.data.attributes.formats.medium.url
            }
      ...
      <div className="uk-container uk-container-medium  uk-animation-slide-bottom  uk-background-muted ">
        <div className="uk-section uk-flex uk-flex-wrap" id="rya_section">
          <div
            className="uk-width-1-2@m uk-flex uk-flex-middle uk-flex-center "
            uk-scrollspy="cls: uk-animation-slide-left; repeat: false"
          >
            <h2>
              {" "}
              <strong>WE ARE RECOGNIZED </strong>{" "}
            </h2>
          </div>
          ...
          >
            {about.attributes.rya_image.data.attributes.url && (
              <img
                src={about.attributes.rya_image.data.attributes.url}
                alt="rya_logo"
                width={250}
              />
            )}
        ...
        <div className="uk-section uk-flex uk-flex-wrap ">
          <div className="uk-width-1-2@m uk-flex uk-flex-middle uk-flex-center  ">
            <h2 uk-scrollspy="cls: uk-animation-slide-left; repeat: false">
              {" "}
              <strong>
                ABOUT THE R<span className="rya-letter">Y</span>A
              </strong>{" "}
            </h2>
          </div>
          ...
          >
            {about && (
              <ReactMarkdown>{about.attributes.rya.description}</ReactMarkdown>
            )}
            <Link href={"/rya"} passHref>
              <button className="uk-button uk-button-default uk-margin-large">
                {" "}
                READ MORE
              </button>
            </Link>
      ...
      <div
        className="uk-container uk-container-expand uk-padding-remove uk-animation-slide-bottom uk-background-muted  "
        id="sailing_area"
      >
        {about.attributes.sailing_image.data.attributes.url && (
          <div
            className=" uk-background-cover  uk-width-1-1@m"
          ...
          >
            <div className="uk-section uk-flex uk-light uk-flex-wrap">
              <div className="uk-width-1-2@m uk-flex  uk-flex-middle"></div>
      ...
      <div className="uk-container uk-container-medium  uk-background-muted uk-padding-large   ">
        ...
        <div className="uk-container uk-container-medium uk-flex uk-flex-center ">
          <div
            className="uk-container uk-container-large uk-slider-container-offset uk-padding  "
            uk-slider="finite: true"
            uk-slideshow
            uk-scrollspy="cls: uk-animation-slide-left; repeat: false"
          >
            <h1 className="uk-text-center" id="team">
              Meet our Team
            </h1>
      ...
      <div className="uk-container uk-container-medium  uk-background-muted uk-padding-large   ">
        ...
        <div className="uk-container uk-container-medium uk-flex uk-flex-center ">
          <div
            ...
            uk-scrollspy="cls: uk-animation-slide-right; repeat: false"
          >
            <h1 className="uk-text-center" id="club">
              The Seven Seas Club
            </h1>
