  ...
  return (
    <>
      <div className="uk-cover-containe uk-light">
        {homepage && homepage.attributes.seo && (
          <SEO data={homepage.attributes.seo} />
        )}

        <Hero
          courses={courses}
          images={homepage.attributes.hero}
          latestNews={latestNews}
        />

        <div className="uk-section " id="courses_section_banner">
          <div
            className="uk-container uk-container-large uk-flex uk-flex-around uk-flex-wrap  "
            uk-grid
          ...
          >
            <div className="uk-card  uk-flex uk-flex-start uk-flex-column landing-cards">
              <div className="uk-flex uk-flex-column  uk-flex-start ">
                <div className="uk-flex uk-flex-column uk-flex-around uk-flex-middle ">
                  <h3 className="uk-card-title  text-primary-blue">
                    {" "}
                    Sailing Courses{" "}
                  </h3>

                  {images.sail.data.attributes.url && (
                    <img
                      src={images.sail.data.attributes.url}
                      alt="hero_card_sail"
                      width={200}
                      height={250}
                      uk-img
            ...
            <div className="uk-card  uk-flex uk-flex-start uk-flex-column  landing-cards">
              <div className="uk-flex uk-flex-column  uk-flex-start ">
                <div className="uk-flex uk-flex-column uk-flex-around uk-flex-middle">
                  ...
                  {images.motor.data.attributes.url && (
                    <img
                      src={images.motor.data.attributes.url}
                      alt="hero_card_sail"
                      width={200}
                      height={250}
                      uk-img
            ...
            <div className="uk-card  uk-width-medium landing-cards">
              <div className="uk-flex uk-flex-column uk-flex-around uk-flex-middle ">
                ...
                {images.power.data.attributes.url && (
                  <img
                    src={images.power.data.attributes.url}
                    alt="hero_card_sail"
                    width={200}
                    height={250}
                    uk-img
        ...
        <div
          className="uk-section  section_banner "
        ...
        >
          <div className="uk-container uk-container-large uk-flex uk-flex-around uk-flex-start uk-flex-wrap">
            <div className="uk-card  uk-width-medium uk-flex uk-flex-start uk-flex-column landing-cards">
              <div className="uk-flex uk-flex-column  uk-flex-start ">
                <div className="uk-flex uk-flex-column uk-flex-around uk-flex-middle">
                  <h3 className="uk-card-title text-primary-white">
                    {" "}
                    Mile Building{" "}
                  </h3>

                  {images.mile_building.data.attributes.url && (
                    <img
                      src={images.mile_building.data.attributes.url}
                      alt="hero_card_sail"
                      width={200}
                      height={250}
                      uk-img
            ...
            <div className="uk-card uk-flex uk-flex-start uk-flex-column  landing-cards">
              <div className="uk-flex uk-flex-column  uk-flex-start ">
                <div className="uk-flex uk-flex-column uk-flex-around uk-flex-middle">
                  ...
                  {images.yachtmaster.data.attributes.url && (
                    <img
                      src={images.yachtmaster.data.attributes.url}
                      width={200}
                      height={250}
                      alt="hero_card_jet"
                      uk-img
            ...
            <div className="uk-card uk-flex uk-flex-start uk-flex-column  landing-cards">
              <div className="uk-flex uk-flex-column  uk-flex-start ">
                <div className="uk-flex uk-flex-column uk-flex-around uk-flex-middle">
                  ...
                  {images.jet_ski.data.attributes.url && (
                    <img
                      src={images.jet_ski.data.attributes.url}
                      alt="hero_card_sail"
                      width={200}
                      height={250}
                      uk-img
        ...
        <div className="online-courses-container  uk-text-center">
          <h2 className="uk-text-center uk-text-bold  online-text ">
            Online Courses
          </h2>
                    ...
                    course.attributes.courseCategory === "Online" && (
                      <div className="flex_full ">
                        ...
                        >
                          ...
                          >
                            <button
                              className="uk-margin-top align-self-left uk-button-large uk-animation-scale-up uk-button uk-text-bold hero-action "
                              href="#courses_section_banner "
                              uk-scroll
                            >
                              {" "}
                              {course.attributes.title}{" "}
      ...
      <div className="uk-section  uk-dark uk-background-cover  uk-padding-large uk-padding-remove-horizontal  uk-margin-top">
        <div className="uk-container uk-margin-top">
          <h2 className="uk-text-center uk-text-bold  has-text-primary uk-text-uppercase">
            Featured Courses
          </h2>
          <div
            className="uk-position-relative uk-visible-toggle uk-dark"
            tabIndex="-1"
            uk-slider="sets: true; autoplay:true;autoplay-interval: 5000; "
          >
      ...
      <div className=" uk-section uk-dark uk-section-muted uk-background-cover  uk-padding-large uk-padding-remove-horizontal uk-margin  ">
        <div className="uk-container ">
          <h2 className="uk-text-center uk-text-muted  uk-text-bold has-text-primary uk-text-uppercase">
