    ...
    <>
      {homepage && homepage.attributes && (
        <SEO
          ...
          metaTitle="Activities and Services"
        />
      )}
      {imgBanner && (
        <div
      ...
      <div className="uk-container uk-container-medium uk-padding-medium uk-animation-slide-bottom">
        ...
        <div className="uk-flex uk-flex-around uk-flex-wrap uk-margin-large">
          {activities && activities.attributes && (
          ...
          {activities &&
            ...
            activities.map((activitie) =>
              ...
              activitie.attributes.category === "jetski" ? null : (
                <>
        ...
        <h4 className=" uk-padding  t uk-text-bold uk-heading-line ">
        ...
        <h4 className=" uk-padding   uk-text-bold uk-heading-line ">
          <span>Services for Superyachts</span>{" "}
        </h4>
        <div className="uk-flex uk-flex-around uk-flex-wrap">
          {activities && activities.attributes && (
            <SEO data={homepage.attributes.seo} metaTitle="courses" />
