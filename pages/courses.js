    ...
    <>
      <div className="">
        {homepage && homepage.attributes && (
          <SEO data={homepage.attributes.seo} metaTitle="Courses -" />
        )}
        {imgBanner && (
          <div
          ...
          <ul className="uk-switcher uk-margin ">
            <li>
              <div className=" uk-padding-small ">
                <h4
                  className=" uk-padding   uk-text-bold uk-heading-line "
                  id="sailing"
                >
            ...
            <li>
              <div className=" uk-padding-small ">
                <h4
                  ...
                  id="motor_courses"
                >
                  <span> Motor Cruising Courses </span>{" "}
                </h4>
                <div
                  className="uk-flex uk-flex-wrap"
                  uk-toggle="cls: uk-flex; mode: media; media: @m "
            ...
            <li>
              <div className="uk-padding-small">
                <div className="uk-flex uk-flex-column uk-padding">
                  <div
                    className="uk-inline-clip hero-cards uk-margin uk-animation-slide-bottom uk-visible-toggle"
                    tabIndex="-1"
                  >
                    {imgBanner && (
                      <div
                    ...
                    <div className="uk-position-cover card-overlay uk-overlay  uk-hidden-hover cursor-pointer uk-flex uk-flex-center uk-flex-middle">
                      <Link href="/courses/yachtmaster" passHref>
                        <a
                          href=""
                          className="uk-icon uk-position-top-left uk-padding-small"
                        >
                          <svg
                            width="40"
                            height="40"
