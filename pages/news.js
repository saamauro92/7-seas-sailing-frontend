      ...
      {imgBanner && (
        ...
        >
          {homepage && homepage.attributes && (
            <SEO data={homepage.attributes.seo} metaTitle="Blog - " />
          )}
          <h3
          ...
          {news &&
            ...
            news.map((item, index) => (
              <Link href={`/news/${item.attributes.slug}`} key={index} passHref>
                <a href="">
                  <div
                    className="uk-card uk-margin-large uk-padding-small "
                    uk-grid
                  >
                    ...
                    <div className="uk-width-1-2@m uk-padding-small uk-padding-remove-horizontal">
                      <div>Written By: {item.attributes.writtenBy}</div>

                      <div>Posted: {item.attributes.date}</div>
                    </div>
