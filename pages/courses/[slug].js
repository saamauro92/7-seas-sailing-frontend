...
const CourseSection = ({ course, homepage }) => {
  ...
  const testimonials_banner =
    homepage.attributes.hero.testimonials_banner.data.attributes.formats.large
      .url;
    ...
    <>
      ...
      <div className="uk-container uk-container-medium uk-padding-medium uk-animation-slide-bottom uk-background-muted">
        <ul className="uk-breadcrumb uk-width-1-2@m uk-width-1-2@l banner-titles uk-text-bolder  uk-margin-remove uk-padding-small">
          ...
          <li>
            <span>{course.attributes.courseCategory}</span>
          </li>
          <li>
            {" "}
            <span> ... </span>
        ...
        {course.attributes.courseCategory !== "Online" && (
          <h3 className="uk-padding uk-padding-remove-horizontal uk-text-center">
            {" "}
            <strong> Courses Progression</strong>{" "}
          </h3>
        )}
        {course.attributes.courseCategory === "Sail" ? (
          <div className="progresion_wrapper uk-flex uk-flex-baseline uk-flex-center">
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/competent-crew"} passHref>
                <p
                  className={
                    course.attributes.title === "Competent Crew"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
                  {" "}
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/day-skipper"} passHref>
                <p
                  className={
                    course.attributes.title === "Day Skipper"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/coastal-skipper"} passHref>
                <p
                  className={
                    course.attributes.title === "Coastal Skipper"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
          ...
          <div className="progresion_wrapper uk-flex uk-flex-baseline uk-flex-center">
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer ">
              <Link href={"/courses/helmsman-course"} passHref>
                <p
                  className={
                    course.attributes.title === "Helmsman Course "
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link
                href={"/courses/day-skipper-practical-motorcruising"}
                passHref
              >
                <p
                  className={
                    course.attributes.title ===
                    "Day Skipper Practical Motorcruising "
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link
                href={"/courses/coastal-skipper-practical-motorcruising"}
                passHref
              >
                <p
                  className={
                    course.attributes.title ===
                    "Coastal Skipper Practical Motorcruising"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
          ...
          <div className="progresion_wrapper uk-flex uk-flex-baseline uk-flex-center">
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/level-2-powerboat-handling-1"} passHref>
                <p
                  className={
                    course.attributes.title === "Level 2 Powerboat Handling"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/tender-operator"} passHref>
                <p
                  className={
                    course.attributes.title === "Tender Operator"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/intermediate-powerboat-1"} passHref>
                <p
                  className={
                    course.attributes.title === "Intermediate Powerboat"
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
            ...
            <div className="uk-flex uk-flex-column uk-flex-center uk-flex-middle cursor-pointer">
              <Link href={"/courses/advanced-powerboat"} passHref>
                <p
                  className={
                    course.attributes.title === "Advanced Powerboat "
                      ? "progression_button progression_button_active"
                      : "progression_button"
                  }
                >
      ...
      {course.attributes.testimonials.data.length > 0 && (
        <div className="uk-container ">
          {testimonials_banner && (
            <div
              className="uk-light uk-background-cover uk-background-blend-overlay  uk-background-secondary  uk-padding-large uk-padding-remove-horizontal"
              data-src={testimonials_banner}
              data-srcset={testimonials_banner}
              data-uk-img
            >
              <h2 className="uk-text-center uk-text-italic  uk-text-bold">
                HAPPY CLIENTS ABOUT US
              </h2>
              <div
                className="uk-position-relative uk-visible-toggle uk-dark"
                tabIndex="-1"
                uk-slider="sets: true; autoplay:true;autoplay-interval: 4000; "
              >
                <ul className="uk-slider-items uk-child-width-1-1 uk-child-width-1-1@m">
                  {course.attributes.testimonials.data.length > 0 &&
                    course.attributes.testimonials.data.map((item, i) => (
                      <li key={i}>
                        <div className="uk-section uk-text-center">
                          <article className="uk-comment">
                            ...
                            <div className="uk-width-expand">
                              <p className="uk-comment-title uk-margin-remove uk-text-bold">
                ...
                <a
                  className="uk-position-bottom-left uk-position-small "
                  href="#"
                ...
                <a
                  className="uk-position-bottom-right uk-position-small "
                  href="#"
                  uk-slidenav-next
                  uk-slider-item="next"
                >
