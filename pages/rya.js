  ...
  return (
    <>
      {homepage && homepage.attributes && (
        <SEO data={homepage.attributes.seo} metaTitle="About RYA" />
      )}

      {imgBanner && (
        <div
          className="uk-background-blend-soft-light uk-background-primary uk-background-cover uk-height-small  uk-panel uk-flex-wrap uk-flex-column uk-flex uk-flex-center uk-flex-middle uk-padding-large"
          data-src={imgBanner}
