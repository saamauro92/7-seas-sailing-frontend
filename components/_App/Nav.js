                                ...
                                <div className="uk-navbar-left uk-margin-large">
                                    ...
                                    <Link passHref href="/">
                                        <a className="uk-navbar-item uk-logo" uk-toggle="target: #offcanvas-nav-primary" href="">
                                            ...
                                            {homepage.attributes.hero.seven_logo.data.attributes.url && <img src={homepage.attributes.hero.seven_logo.data.attributes.url} alt="logo" width={140} height={68} uk-img />}
                                        </a>
                                    </Link>
                                    ...
                                    <Link passHref href="/rya">
                                        <a className="uk-navbar-item uk-logo" uk-toggle="target: #offcanvas-nav-primary" href="">
                                            ...
                                            {homepage.attributes.hero.rya_training.data.attributes.url && <img src={homepage.attributes.hero.rya_training.data.attributes.url} alt="rya-logo" width={74} height={60} uk-img />}
                                        </a>
                                    </Link>
