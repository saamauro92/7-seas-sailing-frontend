...
function Nav({ courses, activities, homepage }) {
  ...
  return showBar ? (
    <div uk-sticky="animation: uk-animation-fade ; sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky   ; cls-inactive: uk-navbar-default  ; top: 5">
      <nav
        className="uk-navbar-container   uk-navbar  uk-margin-remove uk-navbar-default"
        uk-navbar=""
      >
          ...
          <div className=" uk-navbar-left nav-logos ">
            <Link passHref href="/">
              <a className="uk-navbar-item uk-logo">
                {homepage.attributes.hero.seven_logo.data.attributes.url && (
                  <img
                    src={
                      homepage.attributes.hero.seven_logo.data.attributes.url
                    }
            ...
            <div className="uk-visible@s">
              <Link passHref href="/rya">
                <a href="">
                  {homepage.attributes.hero.rya_training.data.attributes
                    .url && (
                    <img
                      src={
                        homepage.attributes.hero.rya_training.data.attributes
          ...
          <div className="uk-navbar-right">
            <ul className="uk-navbar-nav  " uk-nav="multiple: false">
              <li className="nav-item">
                ...
                <div
                  className="uk-navbar-dropdown uk-navbar-dropdown-bottom-left uk-navbar-dropdown-width-2"
                  ...
                  <ul className="uk-nav uk-navbar-dropdown-nav uk-nav-divider ">
                    <Link passHref href="/aboutus/#team">
                      <li className="uk-parent">
                        <a
                          className="responsive-link-font nav-link"
                          href="#team "
                          uk-scroll
                        >
                          Our team
                    ...
                    <Link passHref href="/aboutus/#club">
                      <li className="uk-parent">
                        <a
                          href="#club "
                          className="nav-link responsive-link-font "
                          uk-scroll
                        >
                          The Seven Seas Club
                        </a>
              ...
              <li className="nav-item">
                ...
                >
                  <ul className="uk-nav uk-navbar-dropdown-nav  uk-nav-divider ">
                    <li>
                      <ul
                        className="uk-nav-start uk-margin-auto-vertical uk-nav-parent-icon uk-padding-small"
                        hidden=""
                      ...
                      >
                        <li className="uk-parent ">
                          ...
                          <ul
                            className="uk-nav-sub  uk-nav-start uk-margin-auto-vertical uk-nav-parent-icon   "
                            hidden=""
                          >
                            {courses
                              .sort((a, b) =>
                              ...
                              .map((course, i) =>
                                course.attributes.courseCategory === "Sail" ? (
                                  <li
                                    className="uk-flex uk-flex-start uk-nav-divider"
                                    key={i}
                                  >
                                    <Link
                                      passHref
                        ...
                        <li className="uk-parent uk-nav-divider ">
                          <Link passHref href="/courses" as={"/courses"}>
                            <a className="nav-link responsive-link-font ">
                              Motor
                            </a>
                          </Link>
              ...
              <li>
                ...
                >
                  <ul className="uk-nav uk-navbar-dropdown-nav   ">
                    <li>
                      <ul
                        className="uk-nav-start  uk-nav-parent-icon "
                        hidden=""
                        uk-nav="multiple: true"
                      >
                        {activities.map((activitie, i) =>
                          activitie.attributes.category === "jetski" ||
                          activitie.attributes.category ===
                            "Mile_Building" ? null : (
                            <li
                              className={
                                i === 0
                                  ? "uk-flex uk-flex-start"
                                  : "uk-flex uk-flex-start uk-nav-divider"
                              }
                              key={i}
                            >
                              <Link
                                passHref
                                href={`/activities-and-services/${activitie.attributes.slug}`}
                              >
                                <a className="nav-link responsive-link-font ">
                                  {" "}
                        ...
                        <li className="uk-parent uk-nav-divider ">
                          ...
                          <ul
                            className="uk-nav-sub  uk-nav-start  uk-nav-parent-icon   "
                            hidden=""
                          >
                            {activities.map((activitie, i) =>
                              activitie.attributes.category ===
              ...
              <li>
                <Link passHref href="/contactus" activeClassName="active">
                  <a className={currentRoute === "/contactus" ? "active" : ""}>
                    {" "}
                    Contact us
                  </a>
                </Link>
    ...
    <nav
      className="uk-navbar-container uk-margin uk-navbar uk-margin-remove uk-navbar-default uk-padding-small"
      uk-navbar=""
    >
      <div className="uk-navbar-left ">
        <a className="uk-navbar-item uk-logo  " href="">
          <Link passHref href="/">
            {homepage.attributes.hero.seven_logo.data.attributes.url && (
              <img
                src={homepage.attributes.hero.seven_logo.data.attributes.url}
                alt="logo"
                width={217}
                height={64}
                uk-img
        ...
        <Link passHref href="/rya">
          <a href="">
            {homepage.attributes.hero.rya_training.data.attributes.url && (
              <img
                src={homepage.attributes.hero.rya_training.data.attributes.url}
                alt="rya-logo"
                width={97}
                height={64}
                uk-img
      ...
      <div className="uk-navbar-right">
        <ul className="uk-navbar-nav">
          <div id="my-id" uk-offcanvas>
            <li>
              <a
                className="uk-navbar-toggle uk-icon uk-navbar-toggle-icon"
            ...
            <div id="offcanvas-nav-primary" uk-offcanvas="overlay: true">
              <div className="uk-offcanvas-bar offcanvas-nav">
                <div className="uk-navbar-left uk-margin-large">
                  <Link passHref href="/">
                    <a
                      ...
                      href=""
                    >
                      {homepage.attributes.hero.seven_logo.data.attributes
                        .url && (
                        <img
                          src={
                            homepage.attributes.hero.seven_logo.data.attributes
                  ...
                  <Link passHref href="/rya">
                    ...
                    >
                      {homepage.attributes.hero.rya_training.data.attributes
                        ...
                        <img
                          src={
                            homepage.attributes.hero.rya_training.data
                              .attributes.url
                          }
                          alt="rya-logo"
                          width={74}
                ...
                <ul
                  className="uk-nav uk-nav-primary uk-nav-start uk-margin-auto-vertical uk-nav-parent-icon uk-list-large "
                  uk-nav="multiple: false"
                >
                  <li className="uk-parent ">
                    <div className=" uk-position-absolute ">
                      <Link passHref href="/aboutus">
                        <a
                          className="nav-link responsive-link-font uk-margin"
                          uk-toggle="target: #offcanvas-nav-primary"
                        >
                          About us
                        </a>
                    ...
                    <ul
                      className="uk-nav-sub uk-nav-start uk-margin-auto-vertical uk-nav-parent-icon  uk-nav-parent-icon "
                      hidden=""
                      uk-nav="multiple: false"
                    >
                  ...
                  <li className="uk-parent  ">
                    ...
                    <a href=""></a>
                    <ul
                      className="uk-nav-sub uk-nav-start uk-margin-auto-vertical uk-nav-parent-icon  uk-nav-parent-icon uk-list-large "
                      hidden=""
                      uk-nav="multiple: false"
                    >
                      <li className="uk-parent ">
                        <div className=" uk-position-absolute ">
                          <Link passHref href="/courses">
                            <a
                              className=" responsive-link-font "
                              uk-toggle="target: #offcanvas-nav-primary"
                            >
                              Sail
                            </a>
                        ...
                        <ul
                          className="uk-nav-sub  uk-nav-start uk-margin-auto-vertical uk-nav-parent-icon  uk-list-large"
                          hidden=""
                          uk-nav="multiple: false"
                        >
