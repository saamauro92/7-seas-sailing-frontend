...
const FooterStyleThree = (data) => {
  ...
  return (
    <>
      <div
        className="uk-container uk-container-large uk-padding-large uk-light "
        style={{ zIndex: "9" }}
      >
        <div className="uk-child-width-1-3@s uk-grid-small uk-flex uk-flex-center  uk-flex-wrap uk-text-center ">
          <div className="uk-card uk-card-small uk-flex uk-flex-center ">
            <div className="uk-card  uk-card-body uk-width-1-2@m uk-padding">
              <span className="uk-icon uk-padding">
                <svg
                  width="60"
                  height="60"
                  viewBox="0 0 20 20"
          ...
          <div className="uk-card  uk-card-small  uk-flex uk-flex-center">
            <div className="uk-card  uk-card-body uk-width-1-2@m uk-padding">
              <span className="uk-padding uk-icon">
                <svg
                  width="60"
                  height="60"
                  viewBox="0 0 20 20"
        ...
        <div className="uk-child-width-1-3@s uk-grid-small uk-flex  uk-flex-wrap u">
          ...
          <div className="uk-card  uk-card-small ">
            <div
              className="uk-card  uk-card-body uk-flex uk-flex-center uk-flex-column "
              uk-form-custom
            >
              <label>
                {" "}
              ...
              >
                <button
                  className="uk-button uk-button-default uk-button-large  uk-margin"
                  type="button"
                  tabIndex="-1"
                >
                  Subscribe
        ...
        <div className="uk-container uk-container-expand uk-flex uk-flex-wrap uk-flex-around uk-padding uk-light  ">
          <div className="uk-container uk-container-medium ">
            <div className="uk-card">
              <h3 className="card-title uk-text-center ">Follow us</h3>
            </div>
            <div className="uk-card ">
              <a
                href=""
                ...
                rel="noreferrer"
              >
                <span className="uk-icon uk-margin-right">
                  <svg
                    width="40"
                    height="40"
                    viewBox="0 0 20 20"
