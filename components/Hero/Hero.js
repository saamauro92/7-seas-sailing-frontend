  ...
  return (
    <>
      <div
        ...
        tabIndex="-1"
        uk-slideshow="autoplay: false; autoplay-interval: 8000; pause-on-hover: true; animation: push"
      >
        <ul
        ...
        >
          <li>
            <div className="uk-position-cover hero-wrapper uk-animation-kenburns uk-transform-origin-bottom-center  hero_image_wrapper ">
              {images.background.data.attributes.url && (
                <img
                  src={images.background.data.attributes.url}
                  alt="hero-bg "
                  className="uk-cover  "
                />
              )}
            ...
            <div className=" uk-container uk-container-large uk-flex uk-flex-right uk-padding uk-padding-remove-horizontal ">
              <div className="uk-margin-top uk-padding-large ">
                <h2 className=" uk-heading-small uk-text-bold   uk-animation-scale-up hero-title ">
                  {images.title}{" "}
                </h2>

                <Link
                  href={`/news/${
                    latestNews[latestNews.length - 1].attributes.slug
                  }`}
                  passHref
                >
                  <button
